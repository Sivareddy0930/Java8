...
public class MergeTwoUnsortedArraysInToSortedWithoutDuplicates {

	public static void main(String[] args) {
		
		//Merge Two Unsorted Arrays In To Single Sorted Array withoutDuplicate.
		int arr1[]= {3,4,5,1,2,6};
		int arr2[]= {7,9,4,2,8,10,4};
